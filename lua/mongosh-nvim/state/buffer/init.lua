...
---@class mongo.buffer.BufferResultArgs
---@field type mongo.buffer.BufferType
---@field state_args? table<string, any>

---@class mongo.buffer.MongoBufferOperationModule
---@field on_enter? fun(mbuf: mongo.buffer.MongoBuffer) # Gets called when buffer is going to be displayed in window.
---@field on_show? fun(mbuf: mongo.buffer.MongoBuffer) # Gets called after buffer is displayed in window.
---@field on_leave? fun(mbuf: mongo.buffer.MongoBuffer) # Gets called when buffer is going to be changed to another type.
...
---@class mongo.buffer.MongoBufferCreateArgs
---@field type mongo.buffer.BufferType
